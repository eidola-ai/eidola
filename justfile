...
#
# Build/test eidola-gui for Linux from a macOS host. See oci/eidola-gui/Containerfile
# for the deliberate divergence from the stagex release pipeline. Linux artifacts

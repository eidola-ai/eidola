...
This Agreement governs present and future Contributions that You submit to the Eidola project and its repository, documentation, and related materials (the "Project"). By adding a signer entry for this Agreement to `CLA-SIGNERS.txt` in this repository, You accept these terms for the version of this file identified by that entry's SHA-256 hash.
...
3. For an individual CLA, set `git-email-pattern` to the exact email address You use as the Git author or committer for Contributions.
...
Except for the license granted herein to the Project Owner and to recipients of software distributed by the Project, You reserve all right, title, and interest in and to Your Contributions.

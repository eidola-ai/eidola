...
pub static ALLOWED: LazyLock<Vec<EnclaveMeasurement>> = LazyLock::new(|| {
    vec![
        ...
        // Artifact digest: sha256:9b1a6d486404408e96a40acefbe3499ffac5d55fd08fd5bdcb07beccfda1fdc0
        // Rekor log index: 1466258126
        // Sigstore: https://search.sigstore.dev/?logIndex=1466258126
        // GitHub: https://github.com/tinfoilsh/confidential-model-router/releases/tag/v0.0.95
        EnclaveMeasurement {
            snp_measurement: "69430057351ffdc27d51fdd8f9e113cc23c2b2f485a1cd318f46585f981991a2fc621f958f5f9e13b6578f217c654709".into(),
            tdx_measurement: TdxMeasurement {
                ...
                rtmr2: "84b684bef1006266965cc8cc850a53563d8fac5b270f4a0e1a35fb8e564c9b58cbd310c04c68aac6385c88ec0b017b21".into(),
            },
        },
        // === PREVIOUS: v0.0.84 ===
        // Built: 2026-04-03T16:16:04Z

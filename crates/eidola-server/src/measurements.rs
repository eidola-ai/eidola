...
pub static ALLOWED: LazyLock<Vec<EnclaveMeasurement>> = LazyLock::new(|| {
    vec![
        ...
        // Artifact digest: sha256:a7a8750deb5131eb9b38292946e0858330d62bbfdd7698bb8426b3719658d6cb
        // Rekor log index: 1367789104
        // Sigstore: https://search.sigstore.dev/?logIndex=1367789104
        // GitHub: https://github.com/tinfoilsh/confidential-model-router/releases/tag/v0.0.89
        EnclaveMeasurement {
            snp_measurement: "a556afbcb97cab8b31606df387c5267e6b420fdd032cdb5681d1b2119155ed70ab936c906aaa4b8993f4947fa92aa006".into(),
            tdx_measurement: TdxMeasurement {
                ...
                rtmr2: "339eff182cedd9a8f3e6218588c6173fd2a4855dd222e6928f85eb2a33213b3417682adb462115ad8aab48de168bdcd4".into(),
            },
        },
        // === PREVIOUS: v0.0.84 ===
        // Built: 2026-04-03T16:16:04Z
